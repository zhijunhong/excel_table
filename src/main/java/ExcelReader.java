...
public class ExcelReader {
    ...
    private static int mNeedIndex0;
    private static int mNeedIndex1;
            ...
            while (cellIterator.hasNext()) {
                ...
                if (cell.getRow().getRowNum() == 0) {
                    for (int i = 0; i < cell.getRow().getLastCellNum(); i++) {
                        Cell cell1 = cell.getRow().getCell(i);
                        String rowName = cell1.toString();
                        System.out.print("rowName:" + rowName+"\t");
                    ...
                    Cell cell1 = cell.getRow().getCell(mNeedIndex0);
                    String rowName = cell1.toString();
                    System.out.print("rowName:" + rowName+"\t");
